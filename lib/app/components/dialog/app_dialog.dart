...
class AppDialogs {
  static Future<dynamic> pinVerificationPopUpWidget(
  ...
  static Future<dynamic> verifyOtpPopUpWidget(
    BuildContext context, {
    required Function(dynamic)? onSuccess,
  ...
  static Future<dynamic> successDialogForAll(
    BuildContext context, {
    required String title,
  ...
  static Future<dynamic> globalAppDialogForAll(
    BuildContext context, {
    required String title,
    required String subTitle,
    String buttonTitle = MyStrings.continueText,
  ...
  static Future<dynamic> confirmDialogForAll(
    BuildContext context, {
    String? title,
    String? subTitle,
